...
public interface LifecycleEventListener {
  ...
  /**
   * Called either when the host activity receives a resume event (e.g. {Activity#onResume} or
  ...
  /**
   * Called when host activity receives pause event (e.g. {Activity#onPause}. Always called
   * for the most current activity.
   */
  void onHostPause();

  /**
   * Called when host activity receives destroy event (e.g. {Activity#onDestroy}. Only called
...
// For now they are not required for basic functionality of native modules
