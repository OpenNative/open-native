...
public abstract class ReactContextBaseJavaModule extends BaseJavaModule {
  ...
  protected @Nullable final ReactApplicationContext getReactApplicationContextIfActiveOrWarn() {
    /**
     * There is technically no react or a react instance. so we will usually return just true here always.
     */
  ...
  protected @Nullable final Activity getCurrentActivity() {
    //Nothing special, just calling getCurrentActivity which I think Android's Context already has.
    return mReactApplicationContext.getCurrentActivity();
  }
}

// Reminder: There is no React Instance nor do we need one.
