...
//   }
   ...
   *
   * ** NativeScript **
   * This is the important part. Basically what we care about the most. THE NAME.
   */
  @NonNull
  String getName();

  /**
   * This is called at the end of {CatalystApplicationFragment#createCatalystInstance()} after
