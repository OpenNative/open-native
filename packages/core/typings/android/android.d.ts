...
declare module com {
  export module bridge {
    export class Bridge {
      ...
      public isViewManager(param0: string): boolean;
    ...
    export module react {
      export module bridge {
        export abstract class BaseJavaModule extends com.facebook.react.bridge
          ...
          public static VIEW_MANAGER: boolean;
          public getConstants(): java.util.Map<string, any>;
          public onCatalystInstanceDestroy(): void;
          public constructor();
          public canOverrideExistingModule(): boolean;
        ...
        export class CatalystInstance {
          ...
          public constructor(implementation: {
            ...
            callFunction(
              param0: string,
              param1: string,
              param2: com.facebook.react.bridge.ReadableNativeArray
            ): void;
          });
          public constructor();
          public destroy(): void;
  ...
  export module facebook {
    export module react {
      export module uimanager {
        export abstract class BaseViewManager<T, C> extends com.facebook.react
          .uimanager.ViewManager<any, any> {
          public static class: java.lang.Class<
            com.facebook.react.uimanager.BaseViewManager<any, any>
          >;
          public static VIEW_MANAGER: boolean;
          public onCatalystInstanceDestroy(): void;
          public constructor();
    ...
    export module react {
      export module uimanager {
        export class DisplayMetricsHolder {
          ...
          public static setScreenDisplayMetrics(
            param0: globalAndroid.util.DisplayMetrics
          ): void;
          public static getScreenDisplayMetrics(): globalAndroid.util.DisplayMetrics;
          /** @deprecated */
          public static setWindowDisplayMetrics(
            param0: globalAndroid.util.DisplayMetrics
          ): void;
          /** @deprecated */
          public static getWindowDisplayMetrics(): globalAndroid.util.DisplayMetrics;
          public constructor();
          public static getDisplayMetricsWritableMap(
            param0: number
          ): com.facebook.react.bridge.WritableMap;
          public static initDisplayMetrics(
            param0: globalAndroid.content.Context
          ): void;
          public static initDisplayMetricsIfNotInitialized(
            param0: globalAndroid.content.Context
          ): void;
        }
      }
...
declare module com {
  export module facebook {
    export module react {
      export module uimanager {
        export class RootViewManager extends com.facebook.react.uimanager
          .ViewGroupManager<globalAndroid.view.ViewGroup> {
          ...
          public getName(): string;
          public canOverrideExistingModule(): boolean;
          public createViewInstance(
            param0: com.facebook.react.uimanager.ThemedReactContext
          ): any;
          public createViewInstance(
            param0: com.facebook.react.uimanager.ThemedReactContext
          ): globalAndroid.view.ViewGroup;
          public initialize(): void;
          public invalidate(): void;
        }
      }
...
declare module com {
  export module facebook {
    export module react {
      export module uimanager {
        export abstract class SimpleViewManager<T> extends com.facebook.react
          .uimanager.BaseViewManager<
          any,
          com.facebook.react.uimanager.ReactShadowNode
        > {
          public static class: java.lang.Class<
            com.facebook.react.uimanager.SimpleViewManager<any>
          >;
          public onCatalystInstanceDestroy(): void;
          public constructor();
          public getName(): string;
...
declare module com {
  export module facebook {
    export module react {
      export module uimanager {
        export class ThemedReactContext extends com.facebook.react.bridge
          .ReactContext {
...
declare module com {
  export module facebook {
    export module react {
      export module uimanager {
        export class UIManagerModule extends com.facebook.react.bridge
...
declare module com {
  export module facebook {
    export module react {
      export module uimanager {
        export abstract class ViewGroupManager<T> extends com.facebook.react
          .uimanager.BaseViewManager<
          any,
          com.facebook.react.uimanager.ReactShadowNode
        > {
          public static class: java.lang.Class<
            com.facebook.react.uimanager.ViewGroupManager<any>
          >;
          public static VIEW_MANAGER: boolean;
          ...
          public addViews(
            param0: any,
            param1: java.util.List<globalAndroid.view.View>
          ): void;
          public initialize(): void;
          public addView(
            param0: any,
            param1: globalAndroid.view.View,
            param2: number
          ): void;
          public invalidate(): void;
        }
...
declare module com {
  export module facebook {
    export module react {
      export module uimanager {
        export abstract class ViewManager<T, C> extends com.facebook.react
          .bridge.BaseJavaModule {
          public static class: java.lang.Class<
          ...
          public receiveCommand(
            param0: any,
            param1: string,
            param2: com.facebook.react.bridge.ReadableArray
          ): void;
          public getCommandsMap(): java.util.Map<string, java.lang.Integer>;
          public canOverrideExistingModule(): boolean;
          public getExportedCustomBubblingEventTypeConstants(): java.util.Map<
            string,
            any
          >;
          /** @deprecated */
    ...
    export module react {
      export module uimanager {
        export module events {
          export class ContentSizeChangeEvent extends com.facebook.react
            .uimanager.events
            .Event<com.facebook.react.uimanager.events.ContentSizeChangeEvent> {
      ...
      export module uimanager {
        export module events {
          export abstract class Event<T> extends java.lang.Object {
            public static class: java.lang.Class<
              com.facebook.react.uimanager.events.Event<any>
            >;
            public getSurfaceId(): number;
            public getUniqueID(): number;
            /** @deprecated */
            public dispatch(
              param0: com.facebook.react.uimanager.events.RCTEventEmitter
            ): void;
            public constructor();
            ...
            public getEventData(): com.facebook.react.bridge.WritableMap;
            /** @deprecated */
            public dispatchModernV2(
              param0: com.facebook.react.uimanager.events.RCTModernEventEmitter
            ): void;
      ...
      export module uimanager {
        export module events {
          export class EventDispatcher {
            ...
            public constructor(implementation: {
              dispatchEvent(
                param0: com.facebook.react.uimanager.events.Event<any>
              ): void;
            });
            public constructor();
...
declare module com {
  export module facebook {
    export module react {
      export module uimanager {
        export module events {
          export class RCTEventEmitter extends com.facebook.react.bridge
            .JavaScriptModule {
            ...
            public constructor(implementation: {
              ...
              receiveTouches(
                param0: string,
                param1: com.facebook.react.bridge.WritableArray,
                param2: com.facebook.react.bridge.WritableArray
              ): void;
            });
            public constructor();
            /** @deprecated */
...
declare module com {
  export module facebook {
    export module react {
      export module uimanager {
        export module events {
          export class RCTModernEventEmitter extends com.facebook.react
            .uimanager.events.RCTEventEmitter {
            ...
            public constructor(implementation: {
              ...
              receiveEvent(
                ...
                param3: boolean,
                param4: number,
                param5: com.facebook.react.bridge.WritableMap,
                param6: number
              ): void;
              receiveEvent(
                param0: number,
...
declare module com {
  export module facebook {
    export module react {
      export module uimanager {
        export module events {
          export class ReactEventEmitter extends com.facebook.react.uimanager
            .events.RCTModernEventEmitter {
            ...
            public register(
              param0: number,
              param1: com.facebook.react.uimanager.events.RCTModernEventEmitter
            ): void;
            public receiveEvent(
              param0: number,
              param1: number,
            ...
            public register(
              param0: number,
              param1: com.facebook.react.uimanager.events.RCTEventEmitter
            ): void;
            public receiveEvent(
              param0: number,
              param1: number,
...
declare module com {
  export module facebook {
    export module react {
      export module views {
        export module scroll {
          export class ScrollEvent extends com.facebook.react.uimanager.events
            .Event<com.facebook.react.views.scroll.ScrollEvent> {
            ...
            public static obtain(
              param0: number,
              param1: number,
              param2: com.facebook.react.views.scroll.ScrollEventType,
              param3: number,
              param4: number,
              param5: number,
              param6: number,
            ...
            public static obtain(
              param0: number,
              param1: com.facebook.react.views.scroll.ScrollEventType,
              param2: number,
              param3: number,
              param4: number,
              param5: number,
      ...
      export module views {
        export module scroll {
          export class ScrollEventType {
            ...
            public static getJSEventName(
              param0: com.facebook.react.views.scroll.ScrollEventType
            ): string;
...
declare module com {
  export module testmodule {
    export class ModuleTestViewManager extends com.facebook.react.uimanager
      .SimpleViewManager<globalAndroid.view.View> {
